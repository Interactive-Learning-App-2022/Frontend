...
class Class {
  ...
  getStudentList(listParam) {
    return axios.get(
      "http://127.0.0.1:8000/api/classes/viewStudentsInClass/?class=" +
        listParam.classID
    );
  }
  ...
  getClassList(param) {
    let classlist = {};
    // returns all of the classes available to the teacher
    if (param.role == 1) {
      classlist = axios
        .get("http://127.0.0.1:8000/api/classes/viewClasses/")
        .then((res) =>
          res.data.filter(
            (classrooms) => classrooms.teacher_id === param.userID
          )
        );
      // returns all of the classes the student has enrolled into
    } else {
      classlist = axios
        .get("http://127.0.0.1:8000/api/classes/viewCourseEnrollment/")
        .then((res) =>
          res.data
            .filter((classrooms) => classrooms.student_id.id === param.userID)
  ...
  getClassDetails(param) {
    return axios.get(
      "http://127.0.0.1:8000/api/classes/viewClasses/" + param.classID + "/"
    );
  }
  ...
  getProficienyLevels(param) {
    return axios.get(
      "http://127.0.0.1:8000/api/classes/viewCouseProficiency/" +
        param.classID +
        "/"
    );
  }
  ...
  getPList(param) {
    return axios.get(
      "http://127.0.0.1:8000/api/proficiencies/viewMyProficiencies/?class=" +
        param.classID +
        "&prof=" +
        param.profID
    );
  ...
  getTaskLocation(param) {
    return axios.get(
      "http://127.0.0.1:8000/api/tasks/viewTasks/" + param.taskID + "/"
    );
  }
  ...
  assignTask(param, param1) {
    ...
    console.log(param1);
    return axios.post(
      "http://127.0.0.1:8000/api/tasks/viewAssignNewTask/",
      param1,
      { headers: headers }
    );
  }
  ...
  getTaskList(param) {
    return axios.get(
      "http://127.0.0.1:8000/api/tasks/viewTasks/?proficiency_id=" +
        param.profID
    );
  }
  ...
  getStudentsInTaskPage(param) {
    console.log(param);
    let tasks = axios.get(
      "http://127.0.0.1:8000/api/tasks/viewAssignedTasks/?class=" +
        param.classID
    );
    return tasks;
  }
  ...
  getStudentTasks(param) {
    ...
    console.log(param);
    let tasks = axios.get(
      "http://127.0.0.1:8000/api/tasks/viewAssignedTasks/?student=" +
        param.userID
    );
    return tasks;
  }
  ...
  getAssignedTask(param) {
    let task = axios.get(
      "http://127.0.0.1:8000/api/tasks/viewAssignedTasks/" + param.taskID + "/"
    );
  ...
  getStudentInTarget(param) {
    return _mm.request({
      ...
      type: "get",
      url:
        "https://laravel-lsm.herokuapp.com/api/v1/" +
        param.userID +
        "/classroom/" +
        param.classID +
        "/" +
  ...
  getSubject(param) {
    console.log("PARAM");
    console.log(param);
    let subject = axios.get(
      "http://127.0.0.1:8000/api/classes/viewClasses/?class=" + param.classID
    );
  ...
  getStudentStandards(param) {
    return axios.get(
      "http://127.0.0.1:8000/api/proficiencies/viewMyStandards/?subject=" +
        param.subjectID
    );
  }
  ...
  getAssessment_id(param, standard) {
    let id = axios.get(
      "http://127.0.0.1:8000/api/tasks/viewAssessments/?proficiency_id=" + param
    );
  ...
  AssignAssessment(AssessID, standard) {
    ...
    return axios.post(
      "http://127.0.0.1:8000/api/tasks/viewAssignNewAssessment/",
      JSON.stringify(data),
      { headers: headers }
    );
  }
  ...
  AssignNewAssessment(param) {
    ...
    axios
      .get(
        "http://127.0.0.1:8000/api/tasks/viewAssessments/" +
          param.assessment_id.prev_assessment +
          "/"
      )
      .then((res) =>
        axios
          .get(
            "http://127.0.0.1:8000/api/proficiencies/viewMyProficiencies/?student=" +
              param.assigned_student.id +
              "&prof=" +
              res.data.proficiency_id
          )
          .then((res2) => this.Assign(param, res2))
      );
    return;
  }
  ...
  getStudentAssignedAssessments(param, logic) {
    ...
    if (logic == 0) {
      let assessment = axios.get(
        "http://127.0.0.1:8000/api/tasks/viewAssignedAssessments/?class=" +
          param.classID +
          "&" +
          "user=" +
          param.userID
      ...
      let assessment = axios.get(
        "http://127.0.0.1:8000/api/tasks/viewAssignedAssessments/?id=" + param
      );
  ...
  putAssessmentScores(id, score) {
    ...
    return axios.put(
      "http://127.0.0.1:8000/api/tasks/viewAssignedAssessments/" + id + "/",
      data,
      { headers: headers }
    );
  }
  ...
  putProficiencyScores(id, score) {
    ...
    axios
      .get("http://127.0.0.1:8000/api/tasks/viewAssignedAssessments/" + id)
      .then((res) =>
        axios.put(
          "http://127.0.0.1:8000/api/proficiencies/viewMyProficiencies/" +
            res.data.proficiency_id +
            "/",
          data,
          { headers: headers }
