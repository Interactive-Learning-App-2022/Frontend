...
from .views import TaskAPIView, TasksAssignedAPIView, AssignNewTask, AssignNewAssessment, AssessmentView, AssessmentAssignedAPIView, VideoModuleAPIView
...
router.register(r'VideoModules', VideoModuleAPIView, 'VideoModule')
