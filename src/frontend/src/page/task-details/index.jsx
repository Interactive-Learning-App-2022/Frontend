                                ...
                                return (
                                    <div className="card col-md-3" key={index} ref={c => this.checkDue(modules.due_date, c)} style={{ padding: "0px", marginLeft: "20px" }}>
                                        <div className="card-header" role="button" data-toggle="tooltip" data-placement="bottom" style={{ backgroundColor: "#C8C8C8" }}>
                                            <a onClick={modules.status == 2 ? (e) => this.toRecord(e, modules.scores_id.id) : (e) => this.openModal(e)}>
                                        ...
                                        <div className="card-body" style={{ backgroundColor: "#02D0FF", padding: "0" }}>
                                            <a onClick={modules.status == 2 ? (e) => this.toRecord(e, modules.scores_id.id) : (e) => this.openModal(e)}>
                                                <div className="content-left col-md-6 display-inline" style={modules.scores_id.orginal_proficient ? (modules.scores_id.orginal_proficient == "0" ? { backgroundColor: "#02B385" } : { backgroundColor: "#BC0000" }) : {}} >
                                                    <p className="text-center text-white text-25" >{modules.scores_id.orginal_proficient ? (modules.scores_id.orginal_proficient == "0" ? 'P' : 'NP') : {}}</p>
                                                    <p className="text-white" style={{ fontSize: "15px", marginLeft: "15px" }}>Original Score</p>
                                                </div>
                                                <div className="col-md-6 display-inline" style={modules.scores_id.currentscore ? (modules.scores_id.currentscore > 75 ? { backgroundColor: "#01CF85" } : (modules.scores_id.currentscore > 40 ? { backgroundColor: "#FFD800" } : { backgroundColor: "#FE4C4C" })) : {}}>
                                                    <p className="text-center text-white text-25" >{modules.scores_id.currentscore == 0 ? '-' : modules.scores_id.currentscore}</p>
