        ...
        let LayoutRouter = (
            <Layout>
                <Switch>
                    ...
                    <Route exact path="/classroom/:classID/p-page" component={Benchmark} />
                    <Route exaxt path="/standards/:classID/:subjectID" component={Standards} />
                    <Route exact path="/assessment" component={Assessments} />
                    <Route exact path="/assessment/:classID/:userID" component={Student_Assessment} />
                    <Route exact path="/assessment/:classID/:userId/:assessmentID/:assessmentName" component={Assessments} />
                    ...
                    <Route exact path="/classroom/:classID/:targetID" component={TargetDetail} />
